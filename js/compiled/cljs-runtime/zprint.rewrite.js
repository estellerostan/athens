...
var G__50285 = zloc;
var G__50286 = (function (){var G__50287 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__50288 = zloc;
var G__50288__$1 = (((G__50288 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__50288) : rewrite_clj.zip.node.call(null,G__50288)));
if((G__50288__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__50288__$1) : zprint.zutil.edn_STAR_.call(null,G__50288__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__50287) : rewrite_clj.zip.root.call(null,G__50287));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__50285,G__50286) : rewrite_clj.zip.replace.call(null,G__50285,G__50286));
});
/**
...
var G__50308 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__50308;
continue;
}
break;
...
var G__50313 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__50314 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__50313;
out = G__50314;
continue;
} else {
...
var G__50318 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__50319 = cljs.core.next(new_loc);
var G__50320 = replaced_loc;
nloc = G__50318;
new_loc = G__50319;
last_loc = G__50320;
continue;
...
return zprint.rewrite.sort_val((function (){var G__50289 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__50289) : rewrite_clj.zip.down.call(null,G__50289));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__50290_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__50290_SHARP_) : rewrite_clj.zip.tag.call(null,p1__50290_SHARP_)),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__50290_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__50290_SHARP_)),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
