...
var temp__5733__auto___20684 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___20684)){
var seen_errors_20685 = temp__5733__auto___20684;
if(cljs.core.truth_(seen_errors_20685.has(self))){
} else {
seen_errors_20685.add(self);

var temp__5735__auto___20686 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20686)){
var sense_20687 = temp__5735__auto___20686;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20687)].join(''));
} else {
}
}
} else {
