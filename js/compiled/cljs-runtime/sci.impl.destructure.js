...
var G__58646 = sci$impl$destructure$destructure_STAR__$_pb(ret,cljs.core.second(bs),gseq);
var G__58647 = n;
var G__58648 = cljs.core.nnext(bs);
var G__58649 = true;
ret = G__58646;
n = G__58647;
bs = G__58648;
seen_rest_QMARK_ = G__58649;
continue;
} else {
...
var G__58651 = (n + (1));
var G__58652 = cljs.core.next(bs);
var G__58653 = seen_rest_QMARK_;
ret = G__58650;
n = G__58651;
bs = G__58652;
seen_rest_QMARK_ = G__58653;
continue;
}
...
});})(G__58642,gmap,defaults,pvec,bents))
;
return fexpr__58641(G__58642);
})();
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__58624_SHARP_){
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$2((function (){var or__4185__auto__ = mkns;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return cljs.core.namespace(p1__58624_SHARP_);
}
})(),cljs.core.name(p1__58624_SHARP_));
}));
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(mkn,"syms")){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__58625_SHARP_){
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$2((function (){var or__4185__auto__ = mkns;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return cljs.core.namespace(p1__58625_SHARP_);
}
})(),cljs.core.name(p1__58625_SHARP_));
}));
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__58626_SHARP_,p2__58627_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__58626_SHARP_,p2__58627_SHARP_,(function (){var fexpr__58643 = cljs.core.val(entry);
return (fexpr__58643.cljs$core$IFn$_invoke$arity$1 ? fexpr__58643.cljs$core$IFn$_invoke$arity$1(p2__58627_SHARP_) : fexpr__58643.call(null,p2__58627_SHARP_));
})());
}),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(bes,cljs.core.key(entry)),(function (){var fexpr__58644 = cljs.core.key(entry);
return (fexpr__58644.cljs$core$IFn$_invoke$arity$1 ? fexpr__58644.cljs$core$IFn$_invoke$arity$1(bes) : fexpr__58644.call(null,bes));
})());
...
var G__58655 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):sci$impl$destructure$destructure_STAR__$_pb(ret,bb,bv));
var G__58656 = cljs.core.next(bes);
ret = G__58655;
bes = G__58656;
continue;
} else {
...
var temp__5733__auto__ = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__58628_SHARP_){
return (cljs.core.first(p1__58628_SHARP_) instanceof cljs.core.Keyword);
}),bents));
