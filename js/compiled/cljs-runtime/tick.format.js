...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__53354 = goog.object.get(JSJodaLocale,"Locale");
if((G__53354 == null)){
return null;
} else {
return goog.object.get(G__53354,"US");
}
}catch (e53353){if((e53353 instanceof Error)){
var e = e53353;
return null;
} else {
throw e53353;
