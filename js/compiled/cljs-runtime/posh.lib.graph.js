...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(graph,k,(function (p1__66314_SHARP_){
return cljs.core.disj.cljs$core$IFn$_invoke$arity$2(p1__66314_SHARP_,dep_k);
}));
});
...
var map__66316 = temp__5733__auto__;
var map__66316__$1 = (((((!((map__66316 == null))))?(((((map__66316.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__66316.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__66316):map__66316);
var inputs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66316__$1,new cljs.core.Keyword(null,"inputs","inputs",865803858));
var outputs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66316__$1,new cljs.core.Keyword(null,"outputs","outputs",-1896513034));
