...
shadow.remote.runtime.cljs.browser.abort_BANG_ = (function shadow$remote$runtime$cljs$browser$abort_BANG_(p__60772,action,ex){
...
var state = map__60773__$1;
var callback = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60773__$1,new cljs.core.Keyword(null,"callback","callback",-705136228));
...
return (callback.cljs$core$IFn$_invoke$arity$1 ? callback.cljs$core$IFn$_invoke$arity$1(G__60775) : callback.call(null,G__60775));
});
shadow.remote.runtime.cljs.browser.interpret_action = (function shadow$remote$runtime$cljs$browser$interpret_action(p__60776,p__60777){
...
var action = map__60779__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60779__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var G__60787 = type;
var G__60787__$1 = (((G__60787 instanceof cljs.core.Keyword))?G__60787.fqn:null);
switch (G__60787__$1) {
case "repl/invoke":
var map__60788 = action;
...
var js = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60788__$1,new cljs.core.Keyword(null,"js","js",1768080579));
try{var res = runtime.eval_js(js);
var G__60800 = cljs.core.update.cljs$core$IFn$_invoke$arity$4(state,new cljs.core.Keyword(null,"eval-results","eval-results",553789722),cljs.core.conj,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"value","value",305978217),res,new cljs.core.Keyword(null,"action","action",-811238024),action], null));
return (shadow.remote.runtime.cljs.browser.interpret_actions.cljs$core$IFn$_invoke$arity$1 ? shadow.remote.runtime.cljs.browser.interpret_actions.cljs$core$IFn$_invoke$arity$1(G__60800) : shadow.remote.runtime.cljs.browser.interpret_actions.call(null,G__60800));
}catch (e60799){var ex = e60799;
return shadow.remote.runtime.cljs.browser.abort_BANG_(state,action,ex);
}
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__60787__$1)].join('')));

}
});
shadow.remote.runtime.cljs.browser.interpret_actions = (function shadow$remote$runtime$cljs$browser$interpret_actions(p__60801){
...
var state = map__60802__$1;
var actions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60802__$1,new cljs.core.Keyword(null,"actions","actions",-812656882));
if(cljs.core.empty_QMARK_(actions)){
var fexpr__60804 = new cljs.core.Keyword(null,"callback","callback",-705136228).cljs$core$IFn$_invoke$arity$1(state);
return (fexpr__60804.cljs$core$IFn$_invoke$arity$1 ? fexpr__60804.cljs$core$IFn$_invoke$arity$1(state) : fexpr__60804.call(null,state));
} else {
var map__60805 = cljs.core.first(actions);
...
var action = map__60805__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60805__$1,new cljs.core.Keyword(null,"type","type",1174270348));
...
var self__ = this;
var this$ = this;
var G__60812 = [shadow.cljs.devtools.client.env.get_url_base(),"/worker/compile/",shadow.cljs.devtools.client.env.build_id,"/",shadow.cljs.devtools.client.env.proc_id,"/browser"].join('');
var G__60813 = (function (res){
var req = this;
var map__60817 = shadow.remote.runtime.cljs.browser.transit_read(req.getResponseText());
...
var result = map__60817__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60817__$1,new cljs.core.Keyword(null,"type","type",1174270348));
if((!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("repl","actions","repl/actions",-809718877),type)))){
var G__60819 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"failed","failed",-1397425762),true,new cljs.core.Keyword(null,"result","result",1415092211),result], null);
return (callback.cljs$core$IFn$_invoke$arity$1 ? callback.cljs$core$IFn$_invoke$arity$1(G__60819) : callback.call(null,G__60819));
} else {
...
var G__60814 = "POST";
var G__60815 = shadow.remote.runtime.cljs.browser.transit_str(msg);
var G__60816 = ({"content-type": "application/transit+json; charset=utf-8"});
return goog.net.XhrIo.send(G__60812,G__60813,G__60814,G__60815,G__60816);
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k60808,else__4442__auto__){
var self__ = this;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__60821){
var vec__60822 = p__60821;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60822,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60822,(1),null);
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__60807){
var self__ = this;
var G__60807__$1 = this;
return (new cljs.core.RecordIter((0),G__60807__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ws","ws",86841443),new cljs.core.Keyword(null,"state-ref","state-ref",2127874952)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
var h__4297__auto____$1 = (function (){var fexpr__60825 = (function (coll__4436__auto__){
return (725844968 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__60825(this__4435__auto____$1);
})();
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this60809,other60810){
var self__ = this;
var this60809__$1 = this;
return (((!((other60810 == null)))) && ((this60809__$1.constructor === other60810.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this60809__$1.ws,other60810.ws)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this60809__$1.state_ref,other60810.state_ref)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this60809__$1.__extmap,other60810.__extmap)));
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__60807){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__60826 = cljs.core.keyword_identical_QMARK_;
var expr__60827 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__60829 = new cljs.core.Keyword(null,"ws","ws",86841443);
var G__60830 = expr__60827;
return (pred__60826.cljs$core$IFn$_invoke$arity$2 ? pred__60826.cljs$core$IFn$_invoke$arity$2(G__60829,G__60830) : pred__60826.call(null,G__60829,G__60830));
})())){
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(G__60807,self__.state_ref,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__60831 = new cljs.core.Keyword(null,"state-ref","state-ref",2127874952);
var G__60832 = expr__60827;
return (pred__60826.cljs$core$IFn$_invoke$arity$2 ? pred__60826.cljs$core$IFn$_invoke$arity$2(G__60831,G__60832) : pred__60826.call(null,G__60831,G__60832));
})())){
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,G__60807,self__.__meta,self__.__extmap,null));
} else {
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,self__.state_ref,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__60807),null));
}
}
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__60807){
var self__ = this;
var this__4438__auto____$1 = this;
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,self__.state_ref,G__60807,self__.__extmap,self__.__hash));
}));
 ...
 */
shadow.remote.runtime.cljs.browser.map__GT_BrowserRuntime = (function shadow$remote$runtime$cljs$browser$map__GT_BrowserRuntime(G__60811){
var extmap__4478__auto__ = (function (){var G__60833 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__60811,new cljs.core.Keyword(null,"ws","ws",86841443),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"state-ref","state-ref",2127874952)], 0));
if(cljs.core.record_QMARK_(G__60811)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__60833);
} else {
return G__60833;
}
})();
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(new cljs.core.Keyword(null,"ws","ws",86841443).cljs$core$IFn$_invoke$arity$1(G__60811),new cljs.core.Keyword(null,"state-ref","state-ref",2127874952).cljs$core$IFn$_invoke$arity$1(G__60811),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
var runtime = (function (){var G__60834 = (new shadow.remote.runtime.cljs.browser.BrowserRuntime(socket,state_ref,null,null,null));
shadow.remote.runtime.shared.add_defaults(G__60834);
...
var map__60835 = temp__5737__auto__;
...
var stop = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60835__$1,new cljs.core.Keyword(null,"stop","stop",-2140911342));
