...
posh.lib.update.update_pull = (function posh$lib$update$update_pull(p__46777,storage_key){
var map__46778 = p__46777;
var map__46778__$1 = (((((!((map__46778 == null))))?(((((map__46778.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__46778.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__46778):map__46778);
var posh_tree = map__46778__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46778__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var retrieve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46778__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));
var vec__46780 = storage_key;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46780,(0),null);
var poshdb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46780,(1),null);
var pull_pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46780,(2),null);
var eid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46780,(3),null);
...
posh.lib.update.update_filter_pull = (function posh$lib$update$update_filter_pull(p__46783,storage_key){
var map__46784 = p__46783;
var map__46784__$1 = (((((!((map__46784 == null))))?(((((map__46784.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__46784.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__46784):map__46784);
var posh_tree = map__46784__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46784__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var retrieve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46784__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));
var vec__46786 = storage_key;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46786,(0),null);
var poshdb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46786,(1),null);
var pull_pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46786,(2),null);
var eid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46786,(3),null);
...
posh.lib.update.update_pull_many = (function posh$lib$update$update_pull_many(p__46789,storage_key){
...
var posh_tree = map__46790__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46790__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var retrieve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46790__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));
var vec__46792 = storage_key;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46792,(0),null);
var poshdb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46792,(1),null);
var pull_pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46792,(2),null);
var eids = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46792,(3),null);
...
posh.lib.update.update_q_with_dbvarmap = (function posh$lib$update$update_q_with_dbvarmap(p__46795,storage_key){
...
var posh_tree = map__46796__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46796__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var retrieve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46796__$1,new cljs.core.Keyword(null,"retrieve","retrieve",-657129560));

var vec__46798 = storage_key;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46798,(0),null);
var query = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46798,(1),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46798,(2),null);
...
var poshdbmap = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.merge,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__46802){
var vec__46803 = p__46802;
var db_sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46803,(0),null);
var poshdb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46803,(1),null);
return cljs.core.PersistentArrayMap.createAsIfByAssoc([db_sym,posh.lib.db.poshdb__GT_analyze_db(posh_tree,poshdb)]);
}),dbvarmap));
var fixed_args = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__46806){
var vec__46807 = p__46806;
var sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46807,(0),null);
var arg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46807,(1),null);
...
var G__46810 = cljs.core.first(storage_key);
var G__46810__$1 = (((G__46810 instanceof cljs.core.Keyword))?G__46810.fqn:null);
switch (G__46810__$1) {
case "pull":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__46810__$1)].join('')));
