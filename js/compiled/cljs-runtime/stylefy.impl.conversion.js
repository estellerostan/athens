...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__78092_SHARP_){
return handle_mode(p1__78092_SHARP_,cljs.core.get.cljs$core$IFn$_invoke$arity$2(modes,p1__78092_SHARP_));
}),cljs.core.keys(modes));
} else {
if(cljs.core.vector_QMARK_(modes)){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__78093_SHARP_){
return handle_mode(cljs.core.first(p1__78093_SHARP_),cljs.core.second(p1__78093_SHARP_));
}),modes);
} else {
return null;
}
 ...
 */
stylefy.impl.conversion.convert_base_style_into_class = (function stylefy$impl$conversion$convert_base_style_into_class(p__78106,options){
var map__78107 = p__78106;
var map__78107__$1 = (((((!((map__78107 == null))))?(((((map__78107.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__78107.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__78107):map__78107);
var style = map__78107__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78107__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78107__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var custom_selector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78107__$1,new cljs.core.Keyword(null,"custom-selector","custom-selector",-474556277));
 ...
 */
stylefy.impl.conversion.convert_media_queries = (function stylefy$impl$conversion$convert_media_queries(p__78109,options){
var map__78110 = p__78109;
...
var style = map__78110__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78110__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78110__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var custom_selector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78110__$1,new cljs.core.Keyword(null,"custom-selector","custom-selector",-474556277));
 ...
 */
stylefy.impl.conversion.convert_supports_rules = (function stylefy$impl$conversion$convert_supports_rules(p__78115,options){
var map__78116 = p__78115;
var map__78116__$1 = (((((!((map__78116 == null))))?(((((map__78116.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__78116.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__78116):map__78116);
var style = map__78116__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78116__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78116__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var custom_selector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78116__$1,new cljs.core.Keyword(null,"custom-selector","custom-selector",-474556277));
 ...
 */
stylefy.impl.conversion.convert_manual_styles = (function stylefy$impl$conversion$convert_manual_styles(p__78122,options){
var map__78123 = p__78122;
var map__78123__$1 = (((((!((map__78123 == null))))?(((((map__78123.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__78123.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__78123):map__78123);
var style = map__78123__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78123__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78123__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var custom_selector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78123__$1,new cljs.core.Keyword(null,"custom-selector","custom-selector",-474556277));
...
var manual_selector_and_css_props = clojure.walk.walk((function (p1__78121_SHARP_){
if(cljs.core.map_QMARK_(p1__78121_SHARP_)){
return stylefy.impl.utils.remove_special_keywords(p1__78121_SHARP_);
} else {
return p1__78121_SHARP_;
}
...
(stylefy.impl.conversion.style__GT_css.cljs$core$IFn$_invoke$arity$2 = (function (p__78132,options){
var map__78133 = p__78132;
var map__78133__$1 = (((((!((map__78133 == null))))?(((((map__78133.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__78133.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__78133):map__78133);
var style = map__78133__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78133__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__78133__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
