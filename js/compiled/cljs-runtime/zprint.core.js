...
var vec__51476 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__51479 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51479,(0),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51476,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51476,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__51490){
var vec__51491 = p__51490;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51491,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51491,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51494,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51494,(1),null);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__51510){
var vec__51511 = p__51510;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51511,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51511,(1),null);
...
var len__4789__auto___51564 = arguments.length;
var i__4790__auto___51565 = (0);
while(true){
if((i__4790__auto___51565 < len__4789__auto___51564)){
args__4795__auto__.push((arguments[i__4790__auto___51565]));

var G__51566 = (i__4790__auto___51565 + (1));
i__4790__auto___51565 = G__51566;
continue;
} else {
}
break;
...
var vec__51518 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51518,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51518,(1),null);
...
var G__51521 = zprint.core.parse_string_all_options(rest_options);
var G__51522 = zprint.core.zprint_str_internal;
var G__51523 = ":parse-string-all? call";
var G__51524 = (function (){var G__51525 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__51525) : zprint.zutil.edn_STAR_.call(null,G__51525));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__51521,G__51522,G__51523,G__51524) : zprint.core.process_multiple_forms.call(null,G__51521,G__51522,G__51523,G__51524));
} else {
throw (new Error(":parse-string-all? requires a string!"));
}
} else {
var actual_options = zprint.core.determine_options(rest_options);
var vec__51526 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51526,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51526,(1),null);
...
/** @this {Function} */
(zprint.core.zprint_str_internal.cljs$lang$applyTo = (function (seq51515){
var G__51516 = cljs.core.first(seq51515);
var seq51515__$1 = cljs.core.next(seq51515);
var G__51517 = cljs.core.first(seq51515__$1);
var seq51515__$2 = cljs.core.next(seq51515__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__51516,G__51517,seq51515__$2);
}));
...
var G__51574 = (i__4790__auto___51573 + (1));
i__4790__auto___51573 = G__51574;
continue;
} else {
}
break;
...
var args__4795__auto__ = [];
var len__4789__auto___51575 = arguments.length;
var i__4790__auto___51576 = (0);
while(true){
if((i__4790__auto___51576 < len__4789__auto___51575)){
args__4795__auto__.push((arguments[i__4790__auto___51576]));

var G__51577 = (i__4790__auto___51576 + (1));
i__4790__auto___51576 = G__51577;
continue;
} else {
}
break;
...
var args__4795__auto__ = [];
var len__4789__auto___51581 = arguments.length;
var i__4790__auto___51582 = (0);
while(true){
if((i__4790__auto___51582 < len__4789__auto___51581)){
args__4795__auto__.push((arguments[i__4790__auto___51582]));

var G__51583 = (i__4790__auto___51582 + (1));
i__4790__auto___51582 = G__51583;
continue;
} else {
}
break;
...
var forms = (function (){var G__51552 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__51552) : zprint.zutil.edn_STAR_.call(null,G__51552));
})();
