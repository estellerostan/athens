...
var G__42791 = devtools.prefs.pref(v);
v = G__42791;
continue;
} else {
return v;
...
}catch (e42750){var _e__40091__auto__ = e42750;
return false;
}})();
...
}catch (e42761){var _e__40091__auto__ = e42761;
return false;
}})();
...
}catch (e42765){var _e__40091__auto__ = e42765;
return false;
}}
}
});
...
var vec__42774 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42774,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42774,(1),null);
...
return cljs.core.some((function (p1__42780_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__42780_SHARP_);
}),template);
});
