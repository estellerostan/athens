...
var vec__81609 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81609,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81609,(1),null);
...
var vec__81612 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81612,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81612,(1),null);
if(cljs.core.truth_(end)){
return cljs.core.long$(end);
} else {
...
var vec__81615 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81615,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81615,(1),null);
...
var G__81694 = cljs.core.next(parses__$1);
parses__$1 = G__81694;
continue;
}
...
var G__81633 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__81634 = G__81633;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81634,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81634,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81634,(2),null);
var selection = vec__81634;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__81633__$1 = G__81633;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__81640 = G__81633__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81640,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81640,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81640,(2),null);
var selection__$1 = vec__81640;
...
var G__81696 = cljs.core.long$(end__$1);
var G__81697 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__81698 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__81696;
parses__$1 = G__81697;
G__81633__$1 = G__81698;
continue;
...
var G__81649 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__81650 = G__81649;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81650,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81650,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81650,(2),null);
var selection = vec__81650;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__81649__$1 = G__81649;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__81656 = G__81649__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81656,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81656,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81656,(2),null);
var selection__$1 = vec__81656;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__81700 = cljs.core.long$(end__$1);
var G__81701 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__81702 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__81700;
parses__$1 = G__81701;
G__81649__$1 = G__81702;
continue;
...
var index__$1 = cljs.core.long$(index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__81665 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__81666 = G__81665;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81666,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81666,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81666,(2),null);
var selection = vec__81666;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__81665__$1 = G__81665;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__81672 = G__81665__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81672,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81672,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__81672,(2),null);
var selection__$1 = vec__81672;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__81704 = cljs.core.long$(end__$1);
var G__81705 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__81706 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__81704;
parses__$1 = G__81705;
G__81665__$1 = G__81706;
continue;
...
if(cljs.core.truth_((function (){var fexpr__81677 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__81677.cljs$core$IFn$_invoke$arity$1 ? fexpr__81677.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__81677.call(null,output_format));
})())){
} else {
...
var G__81684 = output_format;
var G__81684__$1 = (((G__81684 instanceof cljs.core.Keyword))?G__81684.fqn:null);
switch (G__81684__$1) {
case "enlive":
...
if(cljs.core.not(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(start_rule),new cljs.core.Keyword(null,"cat","cat",-1457810207)))?(function (){var and__4174__auto__ = (function (){var G__81692 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__81691 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
return (fexpr__81691.cljs$core$IFn$_invoke$arity$1 ? fexpr__81691.cljs$core$IFn$_invoke$arity$1(G__81692) : fexpr__81691.call(null,G__81692));
})();
