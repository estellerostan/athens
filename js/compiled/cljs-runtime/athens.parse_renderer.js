...
var G__58262 = new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"block","block",664686210),(function() { 
var G__58295__delegate = function (contents){
...
var G__58295 = function (var_args){
var contents = null;
if (arguments.length > 0) {
var G__58296__i = 0, G__58296__a = new Array(arguments.length -  0);
while (G__58296__i < G__58296__a.length) {G__58296__a[G__58296__i] = arguments[G__58296__i + 0]; ++G__58296__i;}
  contents = new cljs.core.IndexedSeq(G__58296__a,0,null);
} 
return G__58295__delegate.call(this,contents);};
G__58295.cljs$lang$maxFixedArity = 0;
G__58295.cljs$lang$applyTo = (function (arglist__58297){
var contents = cljs.core.seq(arglist__58297);
return G__58295__delegate(contents);
});
...
var node = (function (){var G__58264 = athens.db.dsdb;
var G__58265 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__58266 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("node","title","node/title",628940777),title], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__58264,G__58265,G__58266) : posh.reagent.pull.call(null,G__58264,G__58265,G__58266));
})();
...
var block = (function (){var G__58267 = athens.db.dsdb;
var G__58268 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__58269 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),uid], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__58267,G__58268,G__58269) : posh.reagent.pull.call(null,G__58267,G__58268,G__58269));
})();
...
})], null),(function (){var G__58270 = new cljs.core.Keyword("block","string","block/string",-2066596447).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(block));
return (athens.parse_renderer.parse_and_render.cljs$core$IFn$_invoke$arity$1 ? athens.parse_renderer.parse_and_render.cljs$core$IFn$_invoke$arity$1(G__58270) : athens.parse_renderer.parse_and_render.call(null,G__58270));
})()], null)], null);
}),new cljs.core.Keyword(null,"hashtag","hashtag",-529028899),(function (tag_name){
var node = (function (){var G__58271 = athens.db.dsdb;
var G__58272 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__58273 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("node","title","node/title",628940777),tag_name], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__58271,G__58272,G__58273) : posh.reagent.pull.call(null,G__58271,G__58272,G__58273));
})();
...
}),new cljs.core.Keyword(null,"url-image","url-image",535142411),(function (p__58274){
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58275__$1,new cljs.core.Keyword(null,"url","url",276297046));
var alt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58275__$1,new cljs.core.Keyword(null,"alt","alt",-3214426));
...
}),new cljs.core.Keyword(null,"url-link","url-link",1615670141),(function (p__58277,text){
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58278__$1,new cljs.core.Keyword(null,"url","url",276297046));
...
var G__58263 = tree;
return (instaparse.core.transform.cljs$core$IFn$_invoke$arity$2 ? instaparse.core.transform.cljs$core$IFn$_invoke$arity$2(G__58262,G__58263) : instaparse.core.transform.call(null,G__58262,G__58263));
});
/**
