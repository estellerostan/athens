...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__66443,fn_name,macro_QMARK_,with_meta_QMARK_){
var map__66444 = p__66443;
...
var _m = map__66444__$1;
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66444__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66444__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66444__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66444__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__66485 = cljs.core.next(args__$1);
var G__66486 = cljs.core.next(params__$1);
var G__66487 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__66485;
params__$1 = G__66486;
ret = G__66487;
continue;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__66454 = ctx__$1;
var G__66455 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__66454,G__66455) : interpret.call(null,G__66454,G__66455));
...
var vec__66456 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66456,(0),null);
var vec__66459 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66456,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66459,(0),null);
...
var map__66462 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66462__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66462__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__66466){
var map__66467 = p__66466;
...
var f = map__66467__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66467__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66467__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
var G__66496__delegate = function (args){
...
while (G__66497__i < G__66497__a.length) {G__66497__a[G__66497__i] = arguments[G__66497__i + 0]; ++G__66497__i;}
  args = new cljs.core.IndexedSeq(G__66497__a,0,null);
} 
return G__66496__delegate.call(this,args);};
G__66496.cljs$lang$maxFixedArity = 0;
G__66496.cljs$lang$applyTo = (function (arglist__66498){
var args = cljs.core.seq(arglist__66498);
return G__66496__delegate(args);
});
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__66464_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__66464_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__66499__delegate = function (args){
...
while (G__66500__i < G__66500__a.length) {G__66500__a[G__66500__i] = arguments[G__66500__i + 0]; ++G__66500__i;}
  args = new cljs.core.IndexedSeq(G__66500__a,0,null);
} 
return G__66499__delegate.call(this,args);};
G__66499.cljs$lang$maxFixedArity = 0;
G__66499.cljs$lang$applyTo = (function (arglist__66501){
var args = cljs.core.seq(arglist__66501);
return G__66499__delegate(args);
});
...
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__66465_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__66465_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
