...
var o42437 = temp__5733__auto__;
var temp__5733__auto____$1 = (o42437["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o42438 = temp__5733__auto____$1;
return (o42438["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__40083__auto__ = f;
return (o__40083__auto__["toString"]).call(o__40083__auto__);
} else {
return "";
}
}catch (e42447){var _ = e42447;
return "";
}});
...
try{var o__40083__auto___42731 = t;
(o__40083__auto___42731["cljs$lang$ctorPrWriter"]).call(o__40083__auto___42731,t,writer);
}catch (e42454){var __42732 = e42454;
}
...
var char_code = (function (){var o__40083__auto__ = (new String(char$));
return (o__40083__auto__["charCodeAt"]).call(o__40083__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__40083__auto__ = String;
return (o__40083__auto__["fromCharCode"]).call(o__40083__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__42455 = num_code;
switch (G__42455) {
case (1):
return (185);
...
var o__40083__auto__ = String;
return (o__40083__auto__["fromCharCode"]).call(o__40083__auto__,superscript_code);
});
/**
...
}catch (e42460){var _e__40091__auto__ = e42460;
return false;
}})())){
...
var vec__42465 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42465,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o42486 = temp__5733__auto__;
var temp__5733__auto____$1 = (o42486["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o42487 = temp__5733__auto____$1;
return (o42487["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__42500){
var vec__42501 = p__42500;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42501,(0),null);
...
var G__42762 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__42763 = cljs.core.butlast(remaining_tokens);
name_tokens = G__42762;
remaining_tokens = G__42763;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq42495){
var G__42496 = cljs.core.first(seq42495);
var seq42495__$1 = cljs.core.next(seq42495);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42496,seq42495__$1);
}));
...
var vec__42512 = cljs.core.split_with((function (p1__42510_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__42510_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42512,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42512,(1),null);
...
var vec__42519 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42519,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42519,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__42768 = cljs.core.rest(remaining_tokens);
var G__42769 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__42768;
name_tokens = G__42769;
continue;
} else {
...
var vec__42524 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42524,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42524,(1),null);
var vec__42527 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42527,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42527,(1),null);
var vec__42530 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42530,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42530,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42530,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42530,(3),null);
...
var vec__42538 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42538,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42538,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42538,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42538,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42538,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42538,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__42542 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42542,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42542,(1),null);
var vec__42546 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42546,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42546,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__42557 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__42557) : devtools.munging.parse_fn_info_deep.call(null,G__42557));
})()));
}
} else {
return fn_info;
...
var G__42784 = (arity + (1));
var G__42785 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__42581){
var vec__42583 = p__42581;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42583,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42583,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42593_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__42593_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42594_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__42594_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__42597){
var vec__42602 = p__42597;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42602,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq42595){
var G__42596 = cljs.core.first(seq42595);
var seq42595__$1 = cljs.core.next(seq42595);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42596,seq42595__$1);
}));
...
var G__42613 = arg;
var G__42613__$1 = (((G__42613 instanceof cljs.core.Keyword))?G__42613.fqn:null);
switch (G__42613__$1) {
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42618__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42618__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42618__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42618__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__42619 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42619,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42619,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42619,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42619,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42619,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42619,(5),null);
...
var o__40083__auto__ = f;
return (o__40083__auto__["getBasis"]).call(o__40083__auto__);
});
/**
...
}catch (e42642){var _e__40091__auto__ = e42642;
...
var G__42800 = (obj[cljs.core.first(path)]);
var G__42801 = cljs.core.rest(path);
obj = G__42800;
path = G__42801;
continue;
} else {
...
var _STAR_ = (function (accum,p__42682){
var vec__42683 = p__42682;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42683,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42683,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__42689){
var vec__42690 = p__42689;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42690,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42690,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42690,(2),null);
...
var post_process = (function (p__42722){
var vec__42723 = p__42722;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42723,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42723,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42716_SHARP_){
return (obj[cljs.core.first(p1__42716_SHARP_)]);
}),sorted_matches);
