...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k48744,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k48744,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__48762){
var vec__48763 = p__48762;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48763,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48763,(1),null);
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__48743){
var self__ = this;
var G__48743__$1 = this;
return (new cljs.core.RecordIter((0),G__48743__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
var h__4297__auto____$1 = (function (){var fexpr__48786 = (function (coll__4436__auto__){
return (1712251858 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__48786(this__4435__auto____$1);
})();
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this48745,other48746){
var self__ = this;
var this48745__$1 = this;
return (((!((other48746 == null)))) && ((this48745__$1.constructor === other48746.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48745__$1.tag,other48746.tag)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48745__$1.prefix,other48746.prefix)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48745__$1.sym,other48746.sym)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48745__$1.children,other48746.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this48745__$1.__extmap,other48746.__extmap)));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__48743){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__48806 = cljs.core.keyword_identical_QMARK_;
var expr__48807 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__48809 = new cljs.core.Keyword(null,"tag","tag",-1290361223);
var G__48810 = expr__48807;
return (pred__48806.cljs$core$IFn$_invoke$arity$2 ? pred__48806.cljs$core$IFn$_invoke$arity$2(G__48809,G__48810) : pred__48806.call(null,G__48809,G__48810));
})())){
return (new rewrite_clj.node.quote.QuoteNode(G__48743,self__.prefix,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__48811 = new cljs.core.Keyword(null,"prefix","prefix",-265908465);
var G__48812 = expr__48807;
return (pred__48806.cljs$core$IFn$_invoke$arity$2 ? pred__48806.cljs$core$IFn$_invoke$arity$2(G__48811,G__48812) : pred__48806.call(null,G__48811,G__48812));
})())){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,G__48743,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__48813 = new cljs.core.Keyword(null,"sym","sym",-1444860305);
var G__48814 = expr__48807;
return (pred__48806.cljs$core$IFn$_invoke$arity$2 ? pred__48806.cljs$core$IFn$_invoke$arity$2(G__48813,G__48814) : pred__48806.call(null,G__48813,G__48814));
})())){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,G__48743,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__48815 = new cljs.core.Keyword(null,"children","children",-940561982);
var G__48816 = expr__48807;
return (pred__48806.cljs$core$IFn$_invoke$arity$2 ? pred__48806.cljs$core$IFn$_invoke$arity$2(G__48815,G__48816) : pred__48806.call(null,G__48815,G__48816));
})())){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,G__48743,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__48743),null));
}
}
}
}
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__48743){
var self__ = this;
var this__4438__auto____$1 = this;
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,G__48743,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.quote.map__GT_QuoteNode = (function rewrite_clj$node$quote$map__GT_QuoteNode(G__48752){
var extmap__4478__auto__ = (function (){var G__48836 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__48752,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__48752)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__48836);
} else {
return G__48836;
}
})();
return (new rewrite_clj.node.quote.QuoteNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__48752),new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(G__48752),new cljs.core.Keyword(null,"sym","sym",-1444860305).cljs$core$IFn$_invoke$arity$1(G__48752),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__48752),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
var G__48886 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__48886;
continue;
}
break;
...
var G__48887 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__48887;
continue;
}
break;
...
var G__48888 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__48888;
continue;
}
break;
...
var G__48889 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__48889;
continue;
}
break;
