...
var vec__70644 = cljs.core.rest(expr);
var seq__70645 = cljs.core.seq(vec__70644);
var first__70646 = cljs.core.first(seq__70645);
var seq__70645__$1 = cljs.core.next(seq__70645);
var vec__70647 = first__70646;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70647,(0),null);
var form = seq__70645__$1;
...
var G__70655 = x;
var G__70655__$1 = (((G__70655 == null))?null:spec_tools.impl.polish(G__70655));
var G__70655__$2 = (((G__70655__$1 == null))?null:cljs.core.name(G__70655__$1));
if((G__70655__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__70655__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__70656 = x;
var G__70656__$1 = (((G__70656 == null))?null:cljs.core.name(G__70656));
if((G__70656__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__70656__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__70657){
var map__70658 = p__70657;
var map__70658__$1 = (((((!((map__70658 == null))))?(((((map__70658.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__70658.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__70658):map__70658);
var data = map__70658__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70658__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70658__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70658__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70658__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__70661){
...
var data = map__70662__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70662__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70662__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__70664 = data;
var G__70664__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__70664,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__70664);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__70664__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__70664__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__70668 = form;
var G__70668__$1 = (((G__70668 == null))?null:cljs.core.rest(G__70668));
if((G__70668__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__70668__$1);
}
})();
var G__70671 = m;
var G__70671__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__70671,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__70665_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__70665_SHARP_)));
})):G__70671);
var G__70671__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__70671__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__70666_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__70666_SHARP_)));
})):G__70671__$1);
var G__70671__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__70671__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__70667_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__70667_SHARP_));
})):G__70671__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__70671__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__70672 = (function (){var G__70673 = form;
var G__70673__$1 = (((G__70673 == null))?null:cljs.core.rest(G__70673));
if((G__70673__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__70673__$1);
}
})();
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70672__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70672__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70672__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70672__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__70675 = (((kw instanceof cljs.core.Symbol))?cljs.core.namespace(kw):false);
switch (G__70675) {
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__70679 = form;
var G__70679__$1 = (((G__70679 == null))?null:cljs.core.seq(G__70679));
var G__70679__$2 = (((G__70679__$1 == null))?null:cljs.core.first(G__70679__$1));
if((G__70679__$2 == null)){
return null;
} else {
var fexpr__70680 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__70680.cljs$core$IFn$_invoke$arity$1 ? fexpr__70680.cljs$core$IFn$_invoke$arity$1(G__70679__$2) : fexpr__70680.call(null,G__70679__$2));
}
})():null));
});
/**
...
var len__4789__auto___70713 = arguments.length;
var i__4790__auto___70714 = (0);
while(true){
if((i__4790__auto___70714 < len__4789__auto___70713)){
args__4795__auto__.push((arguments[i__4790__auto___70714]));

var G__70715 = (i__4790__auto___70714 + (1));
i__4790__auto___70714 = G__70715;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq70683){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq70683));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__70684){
var vec__70685 = p__70684;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70685,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__70685,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__70690){
var map__70691 = p__70690;
var map__70691__$1 = (((((!((map__70691 == null))))?(((((map__70691.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__70691.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__70691):map__70691);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70691__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70691__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70691__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__70691__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__70688_SHARP_){
return cljs.core.map_QMARK_(p1__70688_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__70689_SHARP_){
return cljs.core.contains_QMARK_(p1__70689_SHARP_,x);
});
}),req_keys));
