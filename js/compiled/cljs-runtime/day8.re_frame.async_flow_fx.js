 ...
 */
day8.re_frame.async_flow_fx.dissoc_in = (function day8$re_frame$async_flow_fx$dissoc_in(m,p__67877){
var vec__67878 = p__67877;
var seq__67879 = cljs.core.seq(vec__67878);
var first__67880 = cljs.core.first(seq__67879);
var seq__67879__$1 = cljs.core.next(seq__67879);
var k = first__67880;
var ks = seq__67879__$1;
var keys = vec__67878;
if(ks){
...
var G__67888 = new cljs.core.Keyword(null,"events","events",1792552201).cljs$core$IFn$_invoke$arity$1(task);
var G__67889 = now_seen_events;
var fexpr__67887 = new cljs.core.Keyword(null,"when","when",-576417306).cljs$core$IFn$_invoke$arity$1(task);
return (fexpr__67887.cljs$core$IFn$_invoke$arity$2 ? fexpr__67887.cljs$core$IFn$_invoke$arity$2(G__67888,G__67889) : fexpr__67887.call(null,G__67888,G__67889));
...
var G__67904 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__67905 = "async-flow: got bad value for :when - ";
var G__67906 = when_kw;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__67904,G__67905,G__67906) : re_frame.core.console.call(null,G__67904,G__67905,G__67906));
}
});
/**
...
return cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (index,p__67908){
...
var rule = map__67909__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67909__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var when = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67909__$1,new cljs.core.Keyword(null,"when","when",-576417306));
var events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67909__$1,new cljs.core.Keyword(null,"events","events",1792552201));
var dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67909__$1,new cljs.core.Keyword(null,"dispatch","dispatch",1319337009));
var dispatch_n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67909__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236));
var dispatch_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67909__$1,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614));
var halt_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67909__$1,new cljs.core.Keyword(null,"halt?","halt?",-1110658247));
...
var G__67912 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__67913 = "async-flow: rule can only specify one of :dispatch, :dispatch-n and :dispatch-fn. Got more than one: ";
var G__67914 = rule;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__67912,G__67913,G__67914) : re_frame.core.console.call(null,G__67912,G__67913,G__67914));
} else {
var G__67915 = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),(function (){var or__4185__auto__ = id;
...
var G__67915__$1 = (cljs.core.truth_(dispatch_fn)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__67915,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614),dispatch_fn):G__67915);
if(cljs.core.not(dispatch_fn)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__67915__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236),(cljs.core.truth_(dispatch_n)?dispatch_n:(cljs.core.truth_(dispatch)?(new cljs.core.List(null,dispatch,null,(1),null)):cljs.core.List.EMPTY
)));
} else {
return G__67915__$1;
}
...
var dispatch_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67917__$1,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614));
var dispatch_n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67917__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236));
...
var G__67920 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__67921 = "async-flow: dispatch-fn must return a seq of events ";
var G__67922 = rule;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__67920,G__67921,G__67922) : re_frame.core.console.call(null,G__67920,G__67921,G__67922));
}
} else {
 ...
 */
day8.re_frame.async_flow_fx.make_flow_event_handler = (function day8$re_frame$async_flow_fx$make_flow_event_handler(p__67923){
...
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67924__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var db_path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67924__$1,new cljs.core.Keyword(null,"db-path","db-path",-68094099));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67924__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
var first_dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67924__$1,new cljs.core.Keyword(null,"first-dispatch","first-dispatch",128561923));
...
return (function day8$re_frame$async_flow_fx$make_flow_event_handler_$_async_flow_event_handler(p__67932,p__67933){
var map__67935 = p__67932;
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67935__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__67936 = p__67933;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67936,(0),null);
var event_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67936,(1),null);
var event_v = vec__67936;
var pred__67940 = cljs.core._EQ_;
var expr__67941 = event_type;
if(cljs.core.truth_((function (){var G__67943 = new cljs.core.Keyword(null,"setup","setup",1987730512);
...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"db","db",993250759),(function (){var G__67946 = db;
var G__67947 = cljs.core.PersistentHashSet.EMPTY;
var G__67948 = cljs.core.PersistentHashSet.EMPTY;
return (set_state.cljs$core$IFn$_invoke$arity$3 ? set_state.cljs$core$IFn$_invoke$arity$3(G__67946,G__67947,G__67948) : set_state.call(null,G__67946,G__67947,G__67948));
...
var vec__67950 = event_v;
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67950,(0),null);
var forwarded_event = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67950,(1),null);
var map__67953 = (get_state.cljs$core$IFn$_invoke$arity$1 ? get_state.cljs$core$IFn$_invoke$arity$1(db) : get_state.call(null,db));
...
var seen_events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67953__$1,new cljs.core.Keyword(null,"seen-events","seen-events",1607648392));
var rules_fired = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67953__$1,new cljs.core.Keyword(null,"rules-fired","rules-fired",-1669838140));
...
var vec__67965 = day8.re_frame.async_flow_fx.ensure_has_id(flow);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67965,(0),null);
var flow_SINGLEQUOTE_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67965,(1),null);
...
var G__67968 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [id,new cljs.core.Keyword(null,"setup","setup",1987730512)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__67968) : re_frame.core.dispatch.call(null,G__67968));
});
var G__67969_68089 = new cljs.core.Keyword(null,"async-flow","async-flow",1464712702);
var G__67970_68090 = day8.re_frame.async_flow_fx.flow__GT_handler;
(re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2(G__67969_68089,G__67970_68090) : re_frame.core.reg_fx.call(null,G__67969_68089,G__67970_68090));
