...
var G__56054 = cljs.spec.alpha.get_spec(x);
x = G__56054;
continue;
} else {
...
var G__56055 = cljs.spec.alpha.get_spec(new cljs.core.Keyword(null,"spec","spec",347520401).cljs$core$IFn$_invoke$arity$1(x));
x = G__56055;
continue;
} else {
...
if((x instanceof cljs.core.Keyword)){
var G__56094 = cljs.spec.alpha.get_spec(x);
x = G__56094;
continue;
} else {
