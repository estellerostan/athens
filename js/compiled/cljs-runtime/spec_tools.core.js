...
var G__56036 = cljs.spec.alpha.get_spec(x);
x = G__56036;
continue;
} else {
...
var G__56041 = cljs.spec.alpha.get_spec(new cljs.core.Keyword(null,"spec","spec",347520401).cljs$core$IFn$_invoke$arity$1(x));
x = G__56041;
continue;
} else {
...
if((x instanceof cljs.core.Keyword)){
var G__56082 = cljs.spec.alpha.get_spec(x);
x = G__56082;
continue;
} else {
