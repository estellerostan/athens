...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__75500){
var vec__75501 = p__75500;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75501,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75501,(1),null);
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__75507_SHARP_){
return (((p1__75507_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__75507_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__75512,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__75512;
}
});
...
var len__4789__auto___75554 = arguments.length;
var i__4790__auto___75556 = (0);
while(true){
if((i__4790__auto___75556 < len__4789__auto___75554)){
args__4795__auto__.push((arguments[i__4790__auto___75556]));

var G__75559 = (i__4790__auto___75556 + (1));
i__4790__auto___75556 = G__75559;
continue;
} else {
}
break;
...
var G__75521 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__75521,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__75521;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq75513){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq75513));
}));
...
var vec__75528 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__75535 = cljs.core.ffirst(matches);
var fexpr__75534 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__75534.cljs$core$IFn$_invoke$arity$1 ? fexpr__75534.cljs$core$IFn$_invoke$arity$1(G__75535) : fexpr__75534.call(null,G__75535));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75528,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75528,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__75522_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__75522_SHARP_))){
return p1__75522_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__75523_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__75523_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__75539){
var vec__75540 = p__75539;
...
var tag = first__75542;
var content = seq__75541__$1;
...
var vec__75545 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75545,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75545,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75545,(2),null);
