...
var depth = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62811__$1,new cljs.core.Keyword(null,"depth","depth",1768663640));
var seen = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62811__$1,new cljs.core.Keyword(null,"seen","seen",-518999789));
...
var G__62818 = new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame);
var G__62818__$1 = (((G__62818 == null))?null:cljs.core.persistent_BANG_(G__62818));
if((G__62818__$1 == null)){
return null;
} else {
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__62818__$1,key);
}
});
...
datascript.pull_api.pull_recursion_frame = (function datascript$pull_api$pull_recursion_frame(db,p__62830){
var vec__62831 = p__62830;
var seq__62832 = cljs.core.seq(vec__62831);
var first__62833 = cljs.core.first(seq__62832);
var seq__62832__$1 = cljs.core.next(seq__62832);
var frame = first__62833;
var frames = seq__62832__$1;
...
var results = (function (){var G__62842 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq(kvps)){
return cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(G__62842,kvps);
} else {
return G__62842;
}
})();
...
var map__62848 = parent;
var map__62848__$1 = (((((!((map__62848 == null))))?(((((map__62848.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__62848.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__62848):map__62848);
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62848__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62848__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var pattern_62969 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_62969,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
datascript.pull_api.pull_attr_datoms = (function datascript$pull_api$pull_attr_datoms(db,attr_key,attr,eid,forward_QMARK_,datoms,opts,p__62855){
var vec__62856 = p__62855;
var seq__62857 = cljs.core.seq(vec__62856);
var first__62858 = cljs.core.first(seq__62857);
var seq__62857__$1 = cljs.core.next(seq__62857);
var parent = first__62858;
var frames = seq__62857__$1;
...
var found = cljs.core.not_empty((function (){var G__62859 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.take.cljs$core$IFn$_invoke$arity$1(limit),G__62859);
} else {
return G__62859;
}
})());
...
var as_value = (function (){var G__62868 = datom_val;
if(ref_QMARK_){
return cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__62851_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","id","db/id",-1388397098)],[p1__62851_SHARP_]);
}),G__62868);
} else {
return G__62868;
}
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,cljs.core.update.cljs$core$IFn$_invoke$arity$5(parent,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,(function (){var G__62870 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(as_value),found);
if(single_QMARK_){
return cljs.core.first(G__62870);
} else {
return G__62870;
}
})()));
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,(function (){var G__62871 = parent;
if(cljs.core.contains_QMARK_(opts,new cljs.core.Keyword(null,"default","default",-1987822328))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__62871,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(opts));
} else {
return G__62871;
}
})());
...
var vec__62877 = spec;
var attr_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62877,(0),null);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62877,(1),null);
...
datascript.pull_api.filter_reverse_attrs = cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p__62880){
var vec__62881 = p__62880;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62881,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62881,(1),null);
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__62890){
var vec__62891 = p__62890;
var seq__62892 = cljs.core.seq(vec__62891);
var first__62893 = cljs.core.first(seq__62892);
var seq__62892__$1 = cljs.core.next(seq__62892);
var frame = first__62893;
var frames = seq__62892__$1;
...
datascript.pull_api.pull_expand_frame = (function datascript$pull_api$pull_expand_frame(db,p__62894){
var vec__62895 = p__62894;
var seq__62896 = cljs.core.seq(vec__62895);
var first__62897 = cljs.core.first(seq__62896);
var seq__62896__$1 = cljs.core.next(seq__62896);
var frame = first__62897;
var frames = seq__62896__$1;
...
var vec__62899 = cljs.core.first(datoms_by_attr);
var attr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62899,(0),null);
var datoms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__62899,(1),null);
...
var map__62911 = frame;
var map__62911__$1 = (((((!((map__62911 == null))))?(((((map__62911.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__62911.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__62911):map__62911);
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62911__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62911__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__62917 = recursion;
if((!((attr == null)))){
return datascript.pull_api.push_recursion(G__62917,attr,eid);
} else {
return G__62917;
}
})();
...
var eid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62918__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62918__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__62921){
while(true){
var vec__62927 = p__62921;
var seq__62928 = cljs.core.seq(vec__62927);
var first__62929 = cljs.core.first(seq__62928);
var seq__62928__$1 = cljs.core.next(seq__62928);
var frame = first__62929;
var frames = seq__62928__$1;
var temp__5733__auto__ = cljs.core.seq(new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__5733__auto__){
var eids = temp__5733__auto__;
...
var G__62994 = db;
var G__62995 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__62994;
p__62921 = G__62995;
continue;
}
...
while(true){
var G__62930 = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first(frames));
var G__62930__$1 = (((G__62930 instanceof cljs.core.Keyword))?G__62930.fqn:null);
switch (G__62930__$1) {
case "expand":
var G__62997 = db;
var G__62998 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__62997;
frames = G__62998;
continue;
...
case "expand-rev":
var G__62999 = db;
var G__63000 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__62999;
frames = G__63000;
continue;
...
case "pattern":
var G__63001 = db;
var G__63002 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__63001;
frames = G__63002;
continue;
...
case "recursion":
var G__63003 = db;
var G__63004 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__63003;
frames = G__63004;
continue;
...
break;
case "done":
var vec__62931 = frames;
var seq__62932 = cljs.core.seq(vec__62931);
var first__62933 = cljs.core.first(seq__62932);
var seq__62932__$1 = cljs.core.next(seq__62932);
var f = first__62933;
var remaining = seq__62932__$1;
var result = (function (){var G__62935 = cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not(new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first(G__62935);
} else {
return G__62935;
}
})();
...
var G__63013 = db;
var G__63014 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__62943 = cljs.core.first(remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__62943,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__62943;
}
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__62930__$1)].join('')));
...
var eids__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__62945_SHARP_){
return datascript.db.entid_strict(db,p1__62945_SHARP_);
})),eids);
