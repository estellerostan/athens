...
return (function (p__77245){
var vec__77246 = p__77245;
var event_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77246,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77246,(1),null);
...
var G__77252_77269 = new cljs.core.Keyword(null,"forward-events","forward-events",1216790539);
var G__77253_77270 = (function (){var process_one_entry = (function (p__77254){
var map__77255 = p__77254;
var map__77255__$1 = (((((!((map__77255 == null))))?(((((map__77255.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__77255.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__77255):map__77255);
var m = map__77255__$1;
var unregister = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77255__$1,new cljs.core.Keyword(null,"unregister","unregister",2105339971));
var register = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77255__$1,new cljs.core.Keyword(null,"register","register",1968522516));
var events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77255__$1,new cljs.core.Keyword(null,"events","events",1792552201));
var dispatch_to = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__77255__$1,new cljs.core.Keyword(null,"dispatch-to","dispatch-to",-354764401));
...
var G__77261 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(dispatch_to,event_v);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__77261) : re_frame.core.dispatch.call(null,G__77261));
} else {
return null;
}
});
...
var G__77262 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__77263 = ":forward-events expected a map or a list of maps, but got: ";
var G__77264 = val;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__77262,G__77263,G__77264) : re_frame.core.console.call(null,G__77262,G__77263,G__77264));

}
}
});
})();
(re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2(G__77252_77269,G__77253_77270) : re_frame.core.reg_fx.call(null,G__77252_77269,G__77253_77270));
