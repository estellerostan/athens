...
var G__77980 = new cljs.core.Keyword(null,"reduction-type","reduction-type",-488293450).cljs$core$IFn$_invoke$arity$1(f);
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function instaparse$reduction$iter__77983(s__77984){
return (new cljs.core.LazySeq(null,(function (){
var s__77984__$1 = s__77984;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__77984__$1);
if(temp__5735__auto__){
var s__77984__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__77984__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__77984__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__77986 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__77985 = (0);
while(true){
if((i__77985 < size__4581__auto__)){
var vec__77990 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__77985);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77990,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77990,(1),null);
cljs.core.chunk_append(b__77986,(cljs.core.truth_(new cljs.core.Keyword(null,"red","red",-969428204).cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null)));

var G__78006 = (i__77985 + (1));
i__77985 = G__78006;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__77986),instaparse$reduction$iter__77983(cljs.core.chunk_rest(s__77984__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__77986),null);
}
} else {
var vec__77993 = cljs.core.first(s__77984__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77993,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__77993,(1),null);
return cljs.core.cons((cljs.core.truth_(new cljs.core.Keyword(null,"red","red",-969428204).cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null)),instaparse$reduction$iter__77983(cljs.core.rest(s__77984__$2)));
}
} else {
return null;
}
