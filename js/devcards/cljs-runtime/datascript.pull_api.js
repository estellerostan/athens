...
var pattern_26319 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_26319,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
...
var found = cljs.core.not_empty((function (){var G__26228 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.take.cljs$core$IFn$_invoke$arity$1(limit),G__26228);
} else {
return G__26228;
}
})());
...
break;
case "done":
var vec__26271 = frames;
var seq__26272 = cljs.core.seq(vec__26271);
var first__26273 = cljs.core.first(seq__26272);
var seq__26272__$1 = cljs.core.next(seq__26272);
var f = first__26273;
var remaining = seq__26272__$1;
var result = (function (){var G__26274 = cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not(new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first(G__26274);
} else {
return G__26274;
}
})();
