...
var depth = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53787__$1,new cljs.core.Keyword(null,"depth","depth",1768663640));
var seen = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53787__$1,new cljs.core.Keyword(null,"seen","seen",-518999789));
...
var G__53789 = new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame);
var G__53789__$1 = (((G__53789 == null))?null:cljs.core.persistent_BANG_(G__53789));
if((G__53789__$1 == null)){
return null;
} else {
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__53789__$1,key);
}
});
...
datascript.pull_api.pull_recursion_frame = (function datascript$pull_api$pull_recursion_frame(db,p__53801){
var vec__53802 = p__53801;
var seq__53803 = cljs.core.seq(vec__53802);
var first__53804 = cljs.core.first(seq__53803);
var seq__53803__$1 = cljs.core.next(seq__53803);
var frame = first__53804;
var frames = seq__53803__$1;
...
var results = (function (){var G__53807 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq(kvps)){
return cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(G__53807,kvps);
} else {
return G__53807;
}
})();
...
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53809__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53809__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var pattern_53940 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_53940,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
datascript.pull_api.pull_attr_datoms = (function datascript$pull_api$pull_attr_datoms(db,attr_key,attr,eid,forward_QMARK_,datoms,opts,p__53821){
var vec__53823 = p__53821;
...
var parent = first__53825;
var frames = seq__53824__$1;
...
var found = cljs.core.not_empty((function (){var G__53827 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.take.cljs$core$IFn$_invoke$arity$1(limit),G__53827);
} else {
return G__53827;
}
})());
...
var as_value = (function (){var G__53835 = datom_val;
if(ref_QMARK_){
return cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__53815_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","id","db/id",-1388397098)],[p1__53815_SHARP_]);
}),G__53835);
} else {
return G__53835;
}
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,cljs.core.update.cljs$core$IFn$_invoke$arity$5(parent,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,(function (){var G__53837 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(as_value),found);
if(single_QMARK_){
return cljs.core.first(G__53837);
} else {
return G__53837;
}
})()));
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,(function (){var G__53838 = parent;
if(cljs.core.contains_QMARK_(opts,new cljs.core.Keyword(null,"default","default",-1987822328))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__53838,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(opts));
} else {
return G__53838;
}
})());
...
var vec__53840 = spec;
var attr_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53840,(0),null);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53840,(1),null);
...
datascript.pull_api.filter_reverse_attrs = cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p__53847){
var vec__53848 = p__53847;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53848,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53848,(1),null);
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__53852){
...
var frame = first__53855;
var frames = seq__53854__$1;
...
datascript.pull_api.pull_expand_frame = (function datascript$pull_api$pull_expand_frame(db,p__53859){
...
var frame = first__53862;
var frames = seq__53861__$1;
...
var vec__53863 = cljs.core.first(datoms_by_attr);
var attr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53863,(0),null);
var datoms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53863,(1),null);
...
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53866__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53866__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__53876 = recursion;
if((!((attr == null)))){
return datascript.pull_api.push_recursion(G__53876,attr,eid);
} else {
return G__53876;
}
})();
...
var map__53878 = frame;
var map__53878__$1 = (((((!((map__53878 == null))))?(((((map__53878.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__53878.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__53878):map__53878);
var eid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53878__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53878__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__53885){
while(true){
var vec__53886 = p__53885;
...
var frame = first__53888;
var frames = seq__53887__$1;
var temp__5733__auto__ = cljs.core.seq(new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__5733__auto__){
var eids = temp__5733__auto__;
...
var G__53968 = db;
var G__53969 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__53968;
p__53885 = G__53969;
continue;
}
...
while(true){
var G__53890 = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first(frames));
var G__53890__$1 = (((G__53890 instanceof cljs.core.Keyword))?G__53890.fqn:null);
switch (G__53890__$1) {
case "expand":
var G__53971 = db;
var G__53972 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__53971;
frames = G__53972;
continue;
...
case "expand-rev":
var G__53973 = db;
var G__53974 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__53973;
frames = G__53974;
continue;
...
case "pattern":
var G__53975 = db;
var G__53976 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__53975;
frames = G__53976;
continue;
...
case "recursion":
var G__53978 = db;
var G__53979 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__53978;
frames = G__53979;
continue;
...
var f = first__53893;
var remaining = seq__53892__$1;
var result = (function (){var G__53894 = cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not(new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first(G__53894);
} else {
return G__53894;
}
})();
...
var G__53980 = db;
var G__53981 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__53895 = cljs.core.first(remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__53895,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__53895;
}
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__53890__$1)].join('')));
...
var eids__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__53896_SHARP_){
return datascript.db.entid_strict(db,p1__53896_SHARP_);
})),eids);
