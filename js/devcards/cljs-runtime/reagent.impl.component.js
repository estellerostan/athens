...
if((i < len)){
var k = (ks[i]);
var G__57885 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__57886 = (i + (1));
m = G__57885;
i = G__57886;
continue;
...
var temp__5737__auto__ = p.argv;
if((temp__5737__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__57771 = p.children;
return module$node_modules$react$index.Children.toArray(G__57771);
})());
} else {
var v = temp__5737__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__57773 = c;
var G__57773__$1 = (((G__57773 == null))?null:G__57773.prototype);
if((G__57773__$1 == null)){
return null;
} else {
return G__57773__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__57776 = c;
var G__57776__$1 = (((G__57776 == null))?null:G__57776.prototype);
if((G__57776__$1 == null)){
return null;
} else {
return G__57776__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__57891__delegate = function (args){
var G__57783 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__57783) : reagent.impl.component.as_element.call(null,G__57783));
};
var G__57891 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__57893__i = 0, G__57893__a = new Array(arguments.length -  0);
while (G__57893__i < G__57893__a.length) {G__57893__a[G__57893__i] = arguments[G__57893__i + 0]; ++G__57893__i;}
  args = new cljs.core.IndexedSeq(G__57893__a,0,null);
} 
return G__57891__delegate.call(this,args);};
G__57891.cljs$lang$maxFixedArity = 0;
G__57891.cljs$lang$applyTo = (function (arglist__57897){
var args = cljs.core.seq(arglist__57897);
return G__57891__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__57784 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__57785 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__57785);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__57784);
}});
...
var c = this;
var G__57795_57909 = goog.object.get(c,"cljsRatom");
if((G__57795_57909 == null)){
} else {
reagent.ratom.dispose_BANG_(G__57795_57909);
}
...
var renders_57910 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_57911 = cljs.core.first(cljs.core.vals(renders_57910));
...
if((cljs.core.count(renders_57910) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_57910))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_57911)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_57911], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__57825 = o;
var G__57830_57915 = G__57825;
var G__57831_57916 = cljs.core.name(k);
var G__57832_57917 = v;
goog.object.set(G__57830_57915,G__57831_57916,G__57832_57917);
...
var G__57833_57918 = cmp.prototype;
var G__57834_57919 = module$node_modules$react$index.Component.prototype;
var G__57835_57920 = methods$;
goog.object.extend(G__57833_57918,G__57834_57919,G__57835_57920);
...
var name = (function (){var G__57848 = fiber;
var G__57848__$1 = (((G__57848 == null))?null:G__57848.type);
if((G__57848__$1 == null)){
return null;
} else {
return G__57848__$1.displayName;
}
})();
var parent = (function (){var G__57854 = fiber;
if((G__57854 == null)){
return null;
} else {
return G__57854.return;
}
})();
var path = (function (){var G__57859 = parent;
var G__57859__$1 = (((G__57859 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__57859) : reagent.impl.component.fiber_component_path.call(null,G__57859)));
if((G__57859__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57859__$1)," > "].join('');
}
})();
...
var temp__5733__auto__ = (function (){var or__4185__auto__ = (function (){var G__57863 = c;
if((G__57863 == null)){
return null;
} else {
return goog.object.get(G__57863,"_reactInternalFiber");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__57864._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4185__auto__ = (function (){var G__57866 = c;
if((G__57866 == null)){
return null;
} else {
return goog.object.get(G__57866,"_reactInternalInstance");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var or__4185__auto____$1 = (function (){var G__57868 = c;
if((G__57868 == null)){
return null;
} else {
return G__57868._reactInternalInstance;
}
})();
if(cljs.core.truth_(or__4185__auto____$1)){
return or__4185__auto____$1;
...
var elem = (function (){var or__4185__auto__ = (function (){var G__57870 = instance;
if((G__57870 == null)){
return null;
} else {
return goog.object.get(G__57870,"_currentElement");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var G__57871 = instance;
if((G__57871 == null)){
return null;
} else {
return G__57871._currentElement;
}
}
})();
var name = (function (){var G__57872 = elem;
var G__57872__$1 = (((G__57872 == null))?null:G__57872.type);
if((G__57872__$1 == null)){
return null;
} else {
return G__57872__$1.displayName;
}
})();
var owner = (function (){var or__4185__auto__ = (function (){var G__57874 = elem;
if((G__57874 == null)){
return null;
} else {
return goog.object.get(G__57874,"_owner");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__57875._owner;
}
}
})();
var path = (function (){var G__57876 = owner;
var G__57876__$1 = (((G__57876 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__57876) : reagent.impl.component.component_path.call(null,G__57876)));
if((G__57876__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57876__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__57881 = c;
var G__57881__$1 = (((G__57881 == null))?null:G__57881.constructor);
if((G__57881__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__57881__$1);
}
}
})();
