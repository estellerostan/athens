...
var len__4789__auto___43162 = arguments.length;
var i__4790__auto___43163 = (0);
while(true){
if((i__4790__auto___43163 < len__4789__auto___43162)){
args__4795__auto__.push((arguments[i__4790__auto___43163]));

var G__43164 = (i__4790__auto___43163 + (1));
i__4790__auto___43163 = G__43164;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq42995){
...
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42996,G__42997,seq42995__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__43051_SHARP_){
return (!((cljs.core.meta(p1__43051_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43065__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e43076){var _e__40033__auto__ = e43076;
return false;
}})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
}catch (e43085){var _e__40033__auto__ = e43085;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__43112 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__43113 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__43113);

try{var map__43116 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__43116__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__43112);
}});
...
var temp__5733__auto___43193 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___43193)){
var managed_print_level_43194 = temp__5733__auto___43193;
var _STAR_print_level_STAR__orig_val__43140_43195 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__43141_43196 = managed_print_level_43194;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__43141_43196);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__43133_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__43133_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__43140_43195);
}} else {
job_fn();
}
