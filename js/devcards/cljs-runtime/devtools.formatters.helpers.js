...
var G__42834 = devtools.prefs.pref(v);
v = G__42834;
continue;
} else {
return v;
...
}catch (e42734){var _e__40033__auto__ = e42734;
return false;
}})();
...
}catch (e42757){var _e__40033__auto__ = e42757;
return false;
}})();
...
}catch (e42759){var _e__40033__auto__ = e42759;
return false;
}}
}
});
...
var vec__42770 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42770,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42770,(1),null);
...
return cljs.core.some((function (p1__42781_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__42781_SHARP_);
}),template);
});
