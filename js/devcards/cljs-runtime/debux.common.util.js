...
var G__46052 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__46075 = cljs.core.next(opts__$1);
var G__46076 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__46075;
acc = G__46076;
continue;
} else {
...
var G__46079 = cljs.core.nnext(opts__$1);
var G__46080 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__46079;
acc = G__46080;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__46083 = cljs.core.next(opts__$1);
var G__46084 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__46083;
acc = G__46084;
continue;
} else {
...
var G__46095__i = 0, G__46095__a = new Array(arguments.length -  0);
while (G__46095__i < G__46095__a.length) {G__46095__a[G__46095__i] = arguments[G__46095__i + 0]; ++G__46095__i;}
  arg = new cljs.core.IndexedSeq(G__46095__a,0,null);
} 
