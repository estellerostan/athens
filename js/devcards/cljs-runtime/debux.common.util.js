...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__67935_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__67935_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__67934_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__67934_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__67937_SHARP_){
return (((p1__67937_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__67937_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__67942,mapping){
...
var state = map__67943__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67943__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67943__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__67943__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__67940_SHARP_){
if((p1__67940_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__67940_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__68040 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__68041 = clojure.zip.next(loc);
loc = G__68041;
continue;
}
}
...
var len__4789__auto___68068 = arguments.length;
var i__4790__auto___68069 = (0);
while(true){
if((i__4790__auto___68069 < len__4789__auto___68068)){
args__4795__auto__.push((arguments[i__4790__auto___68069]));

var G__68071 = (i__4790__auto___68069 + (1));
i__4790__auto___68069 = G__68071;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__67952){
var vec__67953 = p__67952;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__67953,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq67950){
var G__67951 = cljs.core.first(seq67950);
var seq67950__$1 = cljs.core.next(seq67950);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__67951,seq67950__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__67956_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__67956_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__67970_68082 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__67971_68083 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__67972_68084 = true;
var _STAR_print_fn_STAR__temp_val__67973_68085 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__67972_68084);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__67973_68085);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__67971_68083);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__67970_68082);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__67965_SHARP_){
return debux.common.util.prepend_bars(p1__67965_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__68091 = cljs.core.next(opts__$1);
var G__68092 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__68091;
acc = G__68092;
continue;
} else {
if(typeof f === 'string'){
var G__68093 = cljs.core.next(opts__$1);
var G__68094 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__68093;
acc = G__68094;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__68095 = cljs.core.nnext(opts__$1);
var G__68096 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__68095;
acc = G__68096;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__68097 = cljs.core.next(opts__$1);
var G__68098 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__68097;
acc = G__68098;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__67978 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__67978.cljs$core$IFn$_invoke$arity$1 ? fexpr__67978.cljs$core$IFn$_invoke$arity$1(f) : fexpr__67978.call(null,f));
})())){
var G__68099 = cljs.core.next(opts__$1);
var G__68100 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__68099;
acc = G__68100;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__67979 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__67979.cljs$core$IFn$_invoke$arity$1 ? fexpr__67979.cljs$core$IFn$_invoke$arity$1(f) : fexpr__67979.call(null,f));
})())){
var G__68101 = cljs.core.nnext(opts__$1);
var G__68102 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__68101;
acc = G__68102;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__68103 = cljs.core.next(opts__$1);
var G__68104 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__68103;
acc = G__68104;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__67981){
...
var G__67989 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__67988 = (function (){var fexpr__67990 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten);
return (fexpr__67990.cljs$core$IFn$_invoke$arity$1 ? fexpr__67990.cljs$core$IFn$_invoke$arity$1(form) : fexpr__67990.call(null,form));
})();
return (fexpr__67988.cljs$core$IFn$_invoke$arity$1 ? fexpr__67988.cljs$core$IFn$_invoke$arity$1(G__67989) : fexpr__67988.call(null,G__67989));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__67997 = quoted_form;
var G__67998 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__67997,G__67998) : debux.common.util.remove_d.call(null,G__67997,G__67998));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__67999 = quoted_form;
var G__68000 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__67999,G__68000) : debux.common.util.remove_d.call(null,G__67999,G__68000));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__68119__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__68008 = quoted_form;
var G__68009 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__68008,G__68009) : debux.common.util.remove_d.call(null,G__68008,G__68009));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
while (G__68120__i < G__68120__a.length) {G__68120__a[G__68120__i] = arguments[G__68120__i + 0]; ++G__68120__i;}
  arg = new cljs.core.IndexedSeq(G__68120__a,0,null);
} 
return G__68119__delegate.call(this,arg);};
G__68119.cljs$lang$maxFixedArity = 0;
G__68119.cljs$lang$applyTo = (function (arglist__68121){
var arg = cljs.core.seq(arglist__68121);
return G__68119__delegate(arg);
});
...
var G__68140 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__68140;
continue;
} else {
...
var G__68141 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__68141;
continue;
} else {
var G__68142 = clojure.zip.next(loc);
loc = G__68142;
continue;
