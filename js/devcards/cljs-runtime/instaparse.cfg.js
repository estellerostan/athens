...
var G__79021 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,G__79021)){
return instaparse.combinators_source.string_ci(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(false,G__79021)){
return instaparse.combinators_source.string(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"default","default",-1987822328),G__79021)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__79021)].join('')));
...
var G__79069 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__79070 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c2);
sq = G__79069;
v = G__79070;
continue;
} else {
var G__79071 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__79072 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,c,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c2], 0));
sq = G__79071;
v = G__79072;
continue;
}
...
break;
case "\"":
var G__79073 = cljs.core.next(sq);
var G__79074 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,"\\",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\""], 0));
sq = G__79073;
v = G__79074;
continue;
...
break;
default:
var G__79075 = cljs.core.next(sq);
var G__79076 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c);
sq = G__79075;
v = G__79076;
continue;
...
while(true){
var G__79035 = (instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.tag.call(null,tree));
var G__79035__$1 = (((G__79035 instanceof cljs.core.Keyword))?G__79035.fqn:null);
switch (G__79035__$1) {
case "rule":
var vec__79036 = (instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.contents.call(null,tree));
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79036,(0),null);
var alt_or_ord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__79036,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1((function (){var G__79039 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(nt) : instaparse.cfg.content.call(null,nt));
return (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(G__79039) : instaparse.cfg.content.call(null,G__79039));
...
break;
case "paren":
var G__79100 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
tree = G__79100;
continue;

break;
case "hide":
return instaparse.combinators_source.hide((function (){var G__79040 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__79040) : instaparse.cfg.build_rule.call(null,G__79040));
})());
...
break;
case "opt":
return instaparse.combinators_source.opt((function (){var G__79041 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__79041) : instaparse.cfg.build_rule.call(null,G__79041));
})());

break;
case "star":
return instaparse.combinators_source.star((function (){var G__79042 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__79042) : instaparse.cfg.build_rule.call(null,G__79042));
})());

break;
case "plus":
return instaparse.combinators_source.plus((function (){var G__79043 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__79043) : instaparse.cfg.build_rule.call(null,G__79043));
})());

break;
case "look":
return instaparse.combinators_source.look((function (){var G__79044 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__79044) : instaparse.cfg.build_rule.call(null,G__79044));
})());

break;
case "neg":
return instaparse.combinators_source.neg((function (){var G__79045 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__79045) : instaparse.cfg.build_rule.call(null,G__79045));
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__79035__$1)].join('')));
...
while(true){
var G__79046 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
var G__79046__$1 = (((G__79046 instanceof cljs.core.Keyword))?G__79046.fqn:null);
switch (G__79046__$1) {
case "nt":
...
case "neg":
case "rep":
var G__79131 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__79131;
continue;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__79046__$1)].join('')));
...
var valid_nts_79141 = cljs.core.set(cljs.core.keys(grammar_map));
var seq__79047_79142 = cljs.core.seq(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(instaparse.cfg.seq_nt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(grammar_map)], 0))));
var chunk__79048_79143 = null;
var count__79049_79144 = (0);
var i__79050_79145 = (0);
while(true){
if((i__79050_79145 < count__79049_79144)){
var nt_79150 = chunk__79048_79143.cljs$core$IIndexed$_nth$arity$2(null,i__79050_79145);
if(cljs.core.truth_((valid_nts_79141.cljs$core$IFn$_invoke$arity$1 ? valid_nts_79141.cljs$core$IFn$_invoke$arity$1(nt_79150) : valid_nts_79141.call(null,nt_79150)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_79150),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__79158 = seq__79047_79142;
var G__79159 = chunk__79048_79143;
var G__79160 = count__79049_79144;
var G__79161 = (i__79050_79145 + (1));
seq__79047_79142 = G__79158;
chunk__79048_79143 = G__79159;
count__79049_79144 = G__79160;
i__79050_79145 = G__79161;
continue;
} else {
var temp__5735__auto___79163 = cljs.core.seq(seq__79047_79142);
if(temp__5735__auto___79163){
var seq__79047_79164__$1 = temp__5735__auto___79163;
if(cljs.core.chunked_seq_QMARK_(seq__79047_79164__$1)){
var c__4609__auto___79169 = cljs.core.chunk_first(seq__79047_79164__$1);
var G__79170 = cljs.core.chunk_rest(seq__79047_79164__$1);
var G__79171 = c__4609__auto___79169;
var G__79172 = cljs.core.count(c__4609__auto___79169);
var G__79173 = (0);
seq__79047_79142 = G__79170;
chunk__79048_79143 = G__79171;
count__79049_79144 = G__79172;
i__79050_79145 = G__79173;
continue;
} else {
var nt_79174 = cljs.core.first(seq__79047_79164__$1);
if(cljs.core.truth_((valid_nts_79141.cljs$core$IFn$_invoke$arity$1 ? valid_nts_79141.cljs$core$IFn$_invoke$arity$1(nt_79174) : valid_nts_79141.call(null,nt_79174)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_79174),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__79175 = cljs.core.next(seq__79047_79164__$1);
var G__79176 = null;
var G__79177 = (0);
var G__79178 = (0);
seq__79047_79142 = G__79175;
chunk__79048_79143 = G__79176;
count__79049_79144 = G__79177;
i__79050_79145 = G__79178;
continue;
}
} else {
}
...
var _STAR_print_newline_STAR__orig_val__79052_79183 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__79053_79184 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__79054_79185 = true;
var _STAR_print_fn_STAR__temp_val__79055_79186 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__79054_79185);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__79055_79186);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__79053_79184);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__79052_79183);
}
...
var len__4789__auto___79204 = arguments.length;
var i__4790__auto___79205 = (0);
while(true){
if((i__4790__auto___79205 < len__4789__auto___79204)){
args__4795__auto__.push((arguments[i__4790__auto___79205]));

var G__79206 = (i__4790__auto___79205 + (1));
i__4790__auto___79205 = G__79206;
continue;
} else {
}
break;
...
(instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__79059){
var map__79060 = p__79059;
...
var opts = map__79060__$1;
var _STAR_case_insensitive_literals_STAR__orig_val__79062 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__79063 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__79063);
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__79064_79208 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__79065_79209 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__79066_79210 = true;
var _STAR_print_fn_STAR__temp_val__79067_79211 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__79066_79210);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__79067_79211);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__79065_79209);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__79064_79208);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})()], 0));
} else {
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__79062);
}}));

(instaparse.cfg.ebnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.cfg.ebnf.cljs$lang$applyTo = (function (seq79057){
var G__79058 = cljs.core.first(seq79057);
var seq79057__$1 = cljs.core.next(seq79057);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__79058,seq79057__$1);
}));
