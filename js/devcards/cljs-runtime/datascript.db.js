...
var G__25948 = only_a;
var G__25949 = only_b;
var G__25950 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(both,first_a);
...
(datascript.db.validate_attr.cljs$core$IFn$_invoke$arity$2 ? datascript.db.validate_attr.cljs$core$IFn$_invoke$arity$2(G__25737_26027,G__25738_26028) : datascript.db.validate_attr.call(null,G__25737_26027,G__25738_26028));
...
var G__26147 = db;
var G__26148 = cljs.core.array_seq.cljs$core$IFn$_invoke$arity$1(eid);
db = G__26147;
eid = G__26148;
continue;
} else {
...
var G__26156 = cljs.core.rest(s__25857__$1);
s__25857__$1 = G__26156;
continue;
}
} else {
return null;
...
var G__26160 = datascript.db.allocate_eid.cljs$core$IFn$_invoke$arity$3(report,old_eid,id);
...
var G__26162 = report;
var G__26163 = cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(entity,new cljs.core.Keyword("db","id","db/id",-1388397098),id),entities);
report = G__26162;
es = G__26163;
continue;
} else {
...
var G__26164 = datascript.db.allocate_eid.cljs$core$IFn$_invoke$arity$3(report,old_eid,upserted_eid);
var G__26165 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(datascript.db.explode(db,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(entity,new cljs.core.Keyword("db","id","db/id",-1388397098),upserted_eid)),entities);
report = G__26164;
es = G__26165;
continue;
}
...
var G__26166 = datascript.db.allocate_eid.cljs$core$IFn$_invoke$arity$3(report,old_eid,new_eid);
var G__26167 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(datascript.db.explode(db,new_entity),entities);
report = G__26166;
es = G__26167;
continue;
} else {
...
var G__26168 = report;
var G__26169 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.apply.cljs$core$IFn$_invoke$arity$3(f,db,args),entities);
report = G__26168;
es = G__26169;
continue;
} else {
...
var G__26175 = datascript.db.transact_add(report,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","add","db/add",235286841),e__$2,a__$1,nv__$1], null));
var G__26176 = entities;
report = G__26175;
es = G__26176;
continue;
} else {
...
var G__26177 = datascript.db.allocate_eid.cljs$core$IFn$_invoke$arity$3(report,e,datascript.db.current_tx(report));
var G__26178 = cljs.core.cons(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [op,datascript.db.current_tx(report),a,v], null),entities);
report = G__26177;
es = G__26178;
continue;
} else {
if(((datascript.db.ref_QMARK_(db,a)) && (datascript.db.tx_id_QMARK_(v)))){
var G__26179 = datascript.db.allocate_eid.cljs$core$IFn$_invoke$arity$3(report,v,datascript.db.current_tx(report));
var G__26180 = cljs.core.cons(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [op,e,a,datascript.db.current_tx(report)], null),entities);
report = G__26179;
es = G__26180;
continue;
} else {
...
if((temp__5737__auto__ == null)){
var G__26182 = datascript.db.allocate_eid.cljs$core$IFn$_invoke$arity$3(report,v,datascript.db.next_eid(db));
var G__26183 = es;
report = G__26182;
es = G__26183;
continue;
...
var G__26184 = report;
var G__26185 = cljs.core.cons(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [op,e,a,vid], null),entities);
report = G__26184;
es = G__26185;
continue;
}
...
var G__26186 = datascript.db.allocate_eid.cljs$core$IFn$_invoke$arity$3(report,e,eid);
var G__26187 = cljs.core.cons(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [op,eid,a,v], null),entities);
report = G__26186;
es = G__26187;
continue;
}
...
var G__26188 = datascript.db.transact_add(report,entity);
...
var G__26194 = datascript.db.transact_retract_datom(report,old_datom);
...
var G__26198 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(datascript.db.transact_retract_datom,report,datoms);
var G__26199 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(datascript.db.retract_components(db,datoms),entities);
report = G__26198;
es = G__26199;
continue;
}
...
var G__26202 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(datascript.db.transact_retract_datom,report,cljs.core.concat.cljs$core$IFn$_invoke$arity$2(e_datoms,v_datoms));
var G__26203 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(datascript.db.retract_components(db,e_datoms),entities);
report = G__26202;
es = G__26203;
continue;
}
...
var G__26205 = datascript.db.transact_add(report,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","add","db/add",235286841),e,a,v,tx], null));
var G__26206 = entities;
report = G__26205;
es = G__26206;
continue;
} else {
var G__26207 = report;
var G__26208 = cljs.core.cons(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","retract","db/retract",-1549825231),e,a,v], null),entities);
report = G__26207;
es = G__26208;
continue;
}
