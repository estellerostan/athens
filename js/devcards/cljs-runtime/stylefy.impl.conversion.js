...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__64346_SHARP_){
return handle_mode(p1__64346_SHARP_,cljs.core.get.cljs$core$IFn$_invoke$arity$2(modes,p1__64346_SHARP_));
}),cljs.core.keys(modes));
} else {
if(cljs.core.vector_QMARK_(modes)){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__64347_SHARP_){
return handle_mode(cljs.core.first(p1__64347_SHARP_),cljs.core.second(p1__64347_SHARP_));
}),modes);
} else {
return null;
}
 ...
 */
stylefy.impl.conversion.convert_base_style_into_class = (function stylefy$impl$conversion$convert_base_style_into_class(p__64356,options){
...
var style = map__64357__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64357__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64357__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var custom_selector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64357__$1,new cljs.core.Keyword(null,"custom-selector","custom-selector",-474556277));
 ...
 */
stylefy.impl.conversion.convert_media_queries = (function stylefy$impl$conversion$convert_media_queries(p__64361,options){
...
var style = map__64362__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64362__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64362__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var custom_selector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64362__$1,new cljs.core.Keyword(null,"custom-selector","custom-selector",-474556277));
 ...
 */
stylefy.impl.conversion.convert_supports_rules = (function stylefy$impl$conversion$convert_supports_rules(p__64384,options){
var map__64385 = p__64384;
...
var style = map__64385__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64385__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64385__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var custom_selector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64385__$1,new cljs.core.Keyword(null,"custom-selector","custom-selector",-474556277));
 ...
 */
stylefy.impl.conversion.convert_manual_styles = (function stylefy$impl$conversion$convert_manual_styles(p__64393,options){
var map__64394 = p__64393;
var map__64394__$1 = (((((!((map__64394 == null))))?(((((map__64394.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__64394.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__64394):map__64394);
var style = map__64394__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64394__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64394__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var custom_selector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64394__$1,new cljs.core.Keyword(null,"custom-selector","custom-selector",-474556277));
...
var manual_selector_and_css_props = clojure.walk.walk((function (p1__64392_SHARP_){
if(cljs.core.map_QMARK_(p1__64392_SHARP_)){
return stylefy.impl.utils.remove_special_keywords(p1__64392_SHARP_);
} else {
return p1__64392_SHARP_;
}
...
(stylefy.impl.conversion.style__GT_css.cljs$core$IFn$_invoke$arity$2 = (function (p__64406,options){
var map__64407 = p__64406;
...
var style = map__64407__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64407__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64407__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
