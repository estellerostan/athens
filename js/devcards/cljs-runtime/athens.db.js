...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__60116_SHARP_){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__60117){
...
}),cljs.core.PersistentArrayMap.EMPTY,p1__60116_SHARP_);
}),hms);
}
});
/**
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__60122_SHARP_){
return cljs.core.cons(new cljs.core.Keyword("db","add","db/add",235286841),p1__60122_SHARP_);
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__60121_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.edn.read_string,p1__60121_SHARP_);
...
var G__60130 = cljs.core.first(new cljs.core.Keyword("block","_children","block/_children",1128070632).cljs$core$IFn$_invoke$arity$1(b));
var G__60131 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(res,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(b,new cljs.core.Keyword("block","_children","block/_children",1128070632)));
b = G__60130;
res = G__60131;
continue;
}
